...
class AppointmentsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvAppointments.adapter = AppointmentAdapter(appointmentsDataSet)//el adapter adapta la informacion para mostrarla en XML e indica como renderizarla, creamos una clase kotlin para esto
    }
}
